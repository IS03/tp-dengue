...
# -*- coding: utf-8 -*-
"""
Script simplificado para generar análisis EDA en 4 formatos diferentes:
...
if df[columna_seleccionada].dtype in ['int64', 'float64']:
    ...
    with col2:
        ...
        st.bar_chart(df[columna_seleccionada].value_counts().head(20))
else:
...
4. Características del dashboard:
   ...
   - Gráficos básicos con Streamlit
